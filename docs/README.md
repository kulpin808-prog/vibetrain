...
В корне репозитория оставлены `DEPLOYMENT.md`, `QUICK_START.md`, `TEST_WEBAPP.md`, `WEBAPP_SETUP.md`, `SETUP_GUIDE.md` — их содержимое по части сценариев перекрыто разделами выше. Для единой картины ориентируйтесь на папку **`docs/`**.
